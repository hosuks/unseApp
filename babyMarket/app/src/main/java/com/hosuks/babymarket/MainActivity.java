...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //-- AdMob
        MobileAds.initialize(getApplicationContext(), "ca-app-pub-1946972349439159~5634801422");
	    ...
	    */
        ...
        mWebView.loadUrl("http://ec2-52-78-110-63.ap-northeast-2.compute.amazonaws.com:9000/diaper");
        ...
        mWebView.setWebViewClient(new WebViewClient(){
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.contains("diaper")) {   // 현재 창에서 열기
                    view.clearView();
